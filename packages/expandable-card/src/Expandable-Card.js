...
import { View, Animated, TouchableOpacity, Platform, Text, StyleSheet, PixelRatio } from 'react-native';
...
export default class ExpandableCard extends Component {
	...
	toggleCard() {
		let finalValue = this.state.toggle ? this.state.minHeight : this.state.maxHeight + this.state.minHeight;
